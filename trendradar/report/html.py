    ...
    *,
    ...
    if report_data["stats"]:
        ...
        for i, stat in enumerate(report_data["stats"], 1):
            ...
            stats_html += f"""
                <div class="word-group foldable-section" id="word-group-{i}" data-tab-index="{i - 1}" data-outline-title="{escaped_word}" data-outline-level="2" data-foldable="true">
            ...
            document.addEventListener('DOMContentLoaded', function() {
                ...
                document.addEventListener('keydown', function(e) {
                    ...
                    switch(e.key) {
                        ...
                        case 'd': case 'D': applyTheme(resolveEffectiveTheme() === 'dark' ? 'light' : 'dark'); break;
